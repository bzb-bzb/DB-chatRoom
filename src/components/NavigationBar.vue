    ...
    <div class="head_con">
        ...
        <div class="wrapper">
            <nav>
                ...
                <input type="radio" name="tab" id="message" :checked="$route.path === '/course'">
                ...
                <label for="message" class="message" @click="delayedNavigation('/course')">
                ...
                <label for="user" class="user" @click="delayedNavigation('/chat')">
                  <el-icon>
                      <DataAnalysis />
                  </el-icon>
                  聊天室
